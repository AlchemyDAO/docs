...
The Alchemy \(ALCH\) token is a standard ERC20 token with custom functions to be used as a governance token. This implementation follows the UNI token implementation as a governance token.
