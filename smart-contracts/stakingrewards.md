...
This contract is an adoption of the StakingRewards.sol from Synthetix.io. In this adoption, the contract does not have a track of a reward token but will use ETH for that.

Basically, the new feature is that the contract issues its ETH balance as the reward to the stakers. 
